...
import com.wipro.eventservice.entity.EventStatus;
...
public interface EventRepository extends JpaRepository<Event, Integer> {
    ...
    Page<Event> findByEventNameContainingIgnoreCaseAndActiveStatusOrderByCreationTimeDesc(
            String eventName, EventStatus status, Pageable pageable);

    Page<Event> findByEventNameContainingIgnoreCaseAndActiveStatus(
            String eventName, EventStatus status, Pageable pageable);
}
